...
export default function Intro() {
    return (
        <div className="flex flex-col justify-center items-center text-center px-10 h-screen gap-8 md:gap-3">
            <Images className="w-[20vw] min-w-[200px] max-w-[375px] mb-4 shadow-neutral-300 shadow-2xl" src={avatar} alt={"Animated style image of Ben Cornell"} />
            <div>
            ...
            characters="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+" 
            sequential="true"
            className="revealed text-[1.5rem] font-primary text-teal-400 md:text-[2rem]" 
            parentClassName="all-letters"
            encryptedClassName="encrypted text-[1.5rem] text-teal-700 font-primary md:text-[2rem]"
            animateOn="view"
            revealDirection="start"
            delay={300}
            />
